...
B=50000
N_TOT = 4584
surface =  input$width  * input$length
volume = input$height  *surface
...
library(EnvStats)
alpha = log(5)/log(4)
proba_infection_sim <- sapply(nb_people_infectious_at_the_event_all[nb_people_infectious_at_the_event_all>=4], function(n){
  if (n>0){
...
n_infections_sim <- sapply(1:2215, function(b){
